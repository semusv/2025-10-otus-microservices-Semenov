...
import com.microservices.delivery.service.ReservationCompensationService;
...
public class ReservationCompensationListener {
    ...
    @KafkaListener(
            topics = "#{@kafkaTopicProperties.getDeliveryReservationCompensationRequest()}",
    ...
    @AsyncListener(
            operation =
                    @AsyncOperation(
                            ...
                            channelName = "#{@kafkaTopicProperties.getDeliveryReservationCompensationRequest()}",
        ...
        try {
            ...
            outboxService.saveEvent(
                    responseEvent.isSuccess()
                            ? EventType.DELIVERY_RESERVATION_COMPENSATION_COMPLETED
                            : EventType.DELIVERY_RESERVATION_COMPENSATION_FAILED,
                    event.getSagaId().toString(),
                    "Saga",
                    responseEvent,
                    kafkaTopicProperties.getDeliveryReservationCompensationResponse());
